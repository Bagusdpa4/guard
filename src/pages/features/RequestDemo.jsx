  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-white px-6 py-8 font-sans lg:px-20 lg:py-16">
      ...
      <motion.div
        ...
        className="relative z-10 mb-8 flex w-full items-center justify-between lg:mb-16 xl:mb-4"
      >
      ...
      >
        <div className="mb-8 flex w-full items-center justify-center gap-6 lg:mb-10 xl:mb-6">
          <img
            src="/logo.png"
            alt="Guard Logo"
            className="h-auto w-[20%] lg:w-[20%] xl:w-[5%]"
          />
          <h1 className="text-primary py-2 text-xl font-black tracking-tight lg:py-2 lg:text-7xl xl:py-2 xl:text-3xl">
            Shelter Guard
          </h1>
        </div>

        {/* Main Container */}
        <div className="mb-10 text-center lg:mb-20 xl:mb-6">
          <p className="mb-2 xl:mb-4 lg:mb-20 mt-4 text-sm font-semibold text-black lg:mt-4 lg:text-4xl xl:mt-2 xl:text-lg">
            Ready to transform your security operations? Book a demo with our
            experts to see how Shelter Guard can secure your assets.
          </p>
